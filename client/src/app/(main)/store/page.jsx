...
const SkeletonCard = () => (
  <div className="bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden shadow-xl p-6 space-y-4 animate-pulse">
    <div className="h-56 bg-zinc-800 rounded-xl w-full" />
    ...
    <div className="h-10 bg-[#FF4E58]/30 rounded-xl mt-5" />
  </div>
);
